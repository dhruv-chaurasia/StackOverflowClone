...
export const updateFriend = (id, userId) =>
  API.patch(`/user/addfriend/${id}`, { userId });
export const deleteFriend = (id, userId) =>
  API.patch(`/user/deletefriend/${id}`, { userId });
...
export const LikePost = (id, value, userId) =>
  API.patch(`/feed/like/${id}`, { value, userId });
export const sharePost = (id, userId) =>
  API.patch(`/feed/share/${id}`, { userId });
